...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /O2 /Ob2 /I "..\include" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D_CRT_SECURE_NO_DEPRECATE /D_CRT_NONSTDC_NO_DEPRECATE /Fp"$(INTDIR)\libfcgi.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
<<
	...
	if exist $(OUTDIR)\libfcgi.dll.manifest mt -manifest $(OUTDIR)\libfcgi.dll.manifest -outputresource:$(OUTDIR)\libfcgi.dll;2
