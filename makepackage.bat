...
set nmakecmd=gdal-java GDAL_DIR=..\sdk\%compiler%\%gdal-dir%\gdal
...
set nmakecmd=ms-autotest MS_DIR=..\sdk\%compiler%\%ms-dir% MSAUTOTEST_DIR=..\sdk\%compiler%\%msautotest-dir%
