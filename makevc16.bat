@echo Setting environment for using Microsoft Visual Studio 2019 x86 tools.

call "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvars32.bat" 10.0.17763.0
E:
